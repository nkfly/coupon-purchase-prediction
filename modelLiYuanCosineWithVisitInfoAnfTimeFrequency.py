...
def compose_train_data(coupon_detail_train, user_hash_to_vector_dict, train_coupon_hash_to_vector_dict):
    ...
    with open(coupon_detail_train, 'r') as csvfile:
        ...
        for row in spamreader:
            ...
            if user_hash not in user_hash_to_count:
                user_hash_to_count[user_hash] = {}
            user_hash_to_count[user_hash][coupon_hash] = True
    ...
    for user_hash in user_hash_to_count:
        user_hash_to_count[user_hash]['buy_coupon_count'] = len(user_hash_to_count[user_hash])
...
def main():
    ...
    with open('prediction.csv', 'w') as w:
        ...
        for user_hash in user_hash_to_coupon_average_cosine_distance:
            ...
            #     threshold = 0
            # else:
            #     threshold = 10 if 10 < user_hash_to_count[user_hash]['buy_coupon_count'] else user_hash_to_count[user_hash]['buy_coupon_count']
